...
from HarleyMusic.utils.database import (add_active_chat,
...
from HarleyMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from HarleyMusic.utils.inline.playlist import close_markup
from HarleyMusic.utils.pastebin import Harleybin
...
async def stream(
    ...
    if forceplay:
        await Harley.force_stop_stream(chat_id)
