...
from HarleyMusic.utils.database import get_authuser_names, get_cmode
from HarleyMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from HarleyMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Harley.stop_stream(message.chat.id)
    except:
        pass
