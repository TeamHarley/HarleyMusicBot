...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TeamHarley/HarleyMusicBot",
)
...
)  # Example:- https://t.me/TheHarley
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/HarleySupport
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @HarleyStringBot
